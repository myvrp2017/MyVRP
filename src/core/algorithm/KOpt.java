...
public class KOpt {
	...
	private static boolean isInsertable(double Capacity, Route route1, Route route2, Delivery customer_j, int i,
		...
		double dist_ij = MyUtility.calculateDistance(customer_i.getLocationOfCustomer(), customer_j.getLocationOfCustomer());
		...
		double dist_ji1 = MyUtility.calculateDistance(customer_j.getLocationOfCustomer(),customer_i1.getLocationOfCustomer());
		...
		Stage S_ij = new Stage(stage_i.getDepartPoint(),customer_j.getLocationOfCustomer(),stage_i.getStartingTime(),
		...
		Stage S_ji1 = new Stage(customer_j.getLocationOfCustomer(),stage_i.getDestinationPoint(),issuingTime_ij+ customer_j.getServiceTime(),
